...
<body>
   ...
   <section class="category">
      ...
      <div class="swiper category-slider">
         ...
         <div class="swiper-wrapper">
            ...
            <a href="category.php?category=Computer Case" class="swiper-slide slide">
               <img src="images/icon-8.png" alt="">
               <h3>Computer Case</h3>
            </a>

            <a href="category.php?category=Video Graphics" class="swiper-slide slide">
               <img src="images/icon-9.png" alt="">
               <h3>Video Graphics</h3>
            </a>

            <a href="category.php?category=Power Supplies" class="swiper-slide slide">
            ...
            <a href="category.php?category=Optical Drives" class="swiper-slide slide">
               <img src="images/icon-11.png" alt="">
               <h3>Optical Drives</h3>

               <a href="category.php?category=Pc Cooling" class="swiper-slide slide">
   ...
   <div id="section3" class="products">
